...
<head>
    ...
    <style>
        * {font-family: "Lucida Grande", Lucida Sans Unicode, Hiragino Sans GB, WenQuanYi Micro Hei, Verdana, Aril, sans-serif;}
        ...
        td{text-align: center;max-width: 20rem;overflow: hidden;text-overflow:ellipsis;overflow: hidden;white-space:nowrap;}
        .table>tbody>tr>td{line-height: 30px;}
        .table>tbody>tr>td>.label{font-size: 1.4rem;font-weight: 300;}
        .mrenm{margin-right: 1rem;}
        .img-thumbnail{width: 120px;height: 60px;}
        .lh60 td{line-height: 60px !important;}
        .martop10 {margin-top: 5%;}
        .checkbox {width: 49%;display: inline-block;}
    </style>
    @yield('css')
</head>
...
<script>
    $('.treeview-menu li a').each(function () {if($(this).attr('href') ==  window.location.pathname  ){$(this).parent().addClass('active');$(this).parent().parent().parent().addClass('active');}});
    $('#example1').DataTable({language: {"sProcessing": "处理中...", "sLengthMenu": "显示 _MENU_ 项结果", "sZeroRecords": "没有匹配结果", "sInfo": "显示第 _START_ 至 _END_ 项结果，共 _TOTAL_ 项", "sInfoEmpty": "显示第 0 至 0 项结果，共 0 项", "sInfoFiltered": "(由 _MAX_ 项结果过滤)", "sInfoPostFix": "", "sSearch": "搜索:", "sUrl": "", "sEmptyTable": "表中数据为空", "sLoadingRecords": "载入中...", "sInfoThousands": ",", "oPaginate": {"sFirst": "首页", "sPrevious": "上页", "sNext": "下页", "sLast": "末页"}, "oAria": {"sSortAscending": ": 以升序排列此列", "sSortDescending": ": 以降序排列此列"}}});
</script>
@yield('js')
</html>
