                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <a href="{{ route('admin.statistical.index') }}" class="btn btn-success pull-right">
                                返回
                            </a>
                            <button style="margin-right: 25px;" class="btn btn-info pull-right"
