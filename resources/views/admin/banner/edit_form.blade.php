            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label >介绍文字</label>
                            <textarea name="intro"  cols="30" rows="3" class="form-control" required>{{ $banner->intro }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>排序</label>
                            <input type="text" name="sort" class="form-control" value="{{ $banner->sort }}" required>
                        </div>
                        <div class="form-group">
                            <label>链接地址</label>
                        ...
                        <div class="form-group">
                            <div class="radio radio-inline">
                                <label>
                                    <input type="radio" name="is_hidden"  value="0" {{ $banner->isHidden() ? 'checked' : ''}}>
                                    启用
                                </label>
                            </div>
                            <div class="radio radio-inline" style="margin-top: 8px">
                                <label>
                                    <input type="radio" name="is_hidden"  value="1" {{ $banner->isHidden() ? '' : 'checked'}}>
                                    禁用
                                </label>
                            </div>
                        </div>
