 ...
 * 中国书法
 *
 * Class ChineseCalligraphyController
 * @package App\Http\Controllers\Home
 */
class ChineseCalligraphyController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            /** @var 轮播图 $banners */
            $banners = Banner::where('is_cat', 40)->orderBy('sort', 'desc')->get();

            /** @var 作品时期 $workdates */
            $workdates = WorkDate::where('worktype_id', 3)->get();

            /** 作者 */
            $artists = Author::where('worktype_id', 3)->get();
